...
/***/ function(module, exports) {
	...
	Cropper.prototype.bindControls = function() {
	  ...
	  this.elements.controls.zoomIn.addEventListener('click', this.cropImage.bind(this));
	  this.elements.controls.zoomOut.addEventListener('click', this.cropImage.bind(this));
	  this.elements.controls.fit.addEventListener('click', this.applyFit.bind(this));
	  this.elements.controls.fit.addEventListener('click', this.cropImage.bind(this));
	  this.elements.controls.crop.addEventListener('click', this.cropImage.bind(this));
	  document.getElementById('imageCropElement').addEventListener('click', this.cropImage.bind(this));
	};
	...
	Cropper.prototype.setDimensions = function() {
	  this.zoomInFactor = 0 + parseFloat(this.options.zoomStep);
	  this.zoomOutFactor = this.zoomInFactor * 0.5;
